...
QString ScanWorker::detectFormat(const QString& ext) const
{
    static const QHash<QString,QString> m = {
        ...
        {"docm","Word"},{"docb","Word"},{"dot","Word Template"},
        {"dotx","Word Template"},{"dotm","Word Template"},
        ...
        {"pot","PowerPoint Template"},{"potx","PowerPoint Template"},
        {"potm","PowerPoint Template"},{"pps","PowerPoint Show"},
        {"ppsx","PowerPoint Show"},{"ppsm","PowerPoint Show"},
        {"sldx","PowerPoint Slide"},{"sldm","PowerPoint Slide"},
        {"vsd","Visio"},{"vsdx","Visio"},{"vsdm","Visio"},
        {"vss","Visio Stencil"},{"vssx","Visio Stencil"},{"vssm","Visio Stencil"},
        {"vst","Visio Template"},{"vstx","Visio Template"},{"vstm","Visio Template"},
        {"vdx","Visio"},{"pub","Publisher"},{"mpp","Project"},{"mpt","Project Template"},
        {"mdb","Access"},{"accdb","Access"},{"msg","Outlook Message"},
